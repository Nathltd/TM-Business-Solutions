...
INSERT into PaymentsGen (PaymentID,PaymentDate,Amount,CustomerID,Type,AccountID,Creator) 
...
FROM PaymentsGen
WHERE PaymentDate = <cfqueryparam value="#lsDateFormat(CreateODBCDate(form.mydate), "dd/mm/yyyy")#" cfsqltype="cf_sql_clob">
...
<cfgridcolumn name = "CustomerID" header = "Customer" width="120" headeralign="center">
