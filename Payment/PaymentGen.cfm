...
<html>
<head>
<title><cfoutput>Payments (General) :: #request.title#</cfoutput></title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  <script type="text/javascript" src="../googleJquery-min.js"></script>
  <script type="text/javascript" src="../googleJquery-ui.min.js"></script>
...
$(function() {
            ...
            $("#ref").autocomplete({
                source: "SalesIdCustomerGen.cfm",
                minLength: 2,
                select: function(event, ui) {

                    $('#customerId').val(ui.item.description);
                }
            });
        });
</script>
...
<div id="Content">
<h4> Payments from Customers (General) </h4>
<div id="RightColumn">
...
<cfset structdelete(session, 'paymentDate')>
<cfset structdelete(session, 'ref')>
<cfset structdelete(session, 'payType')>
...
<cfquery>
INSERT INTO PaymentsGen
(AccountID,CustomerID,PaymentDate,PaymentID,Type,amount,Creator,paydetails)
VALUES ('#session.myInvoice[variables.counter].AccountID#', '#session.myInvoice[variables.counter].CustomerID#', <cfqueryparam value="#lsDateFormat(CreateODBCDate(session.myInvoice[variables.counter].paymentDate), "dd/mm/yyyy")#" cfsqltype="cf_sql_date">,  '#session.myInvoice[variables.counter].ref#', '#session.myInvoice[variables.counter].payType#', '#session.myInvoice[variables.counter].amount#','#GetAuthUser()#','#session.myInvoice[variables.counter].details#')
</cfquery>
</cfloop>
</cftransaction>
...
<cfset session.myInvoice[position].paymentDate = #form.paymentDate#>
<cfset session.myInvoice[position].ref = #form.ref#>
<cfset session.myInvoice[position].Amount = #form.Amount#>
<cfset session.myInvoice[position].payType = #form.payType#>
...
<div align="center"></div>
  <div align="center">
  <table width="95%" bgcolor="##D5EAFF" border="0" cellpadding="3" cellspacing="0" bordercolor="999999">
<thead>
<tr align="center">
<td width="10%" align="center"><div align="left"><strong>Ref. ##</strong></div></td>
<td width="17%"><div align="left"><strong>Customer</strong></div></td>
<td width="25%" align="center"> <div align="left"><strong>Account</strong></div></td>
...
<td width="10%" align="center"> <div align="left"><strong>Details</strong></div></td>
...
<tr>
<td valign="top"> <cfinput type="text" name="ref" validate="integer" message="Enter Invoice No., Figures only." required="yes" id="ref" style="text-align:left;width:100%" tabindex="4" autocomplete="off">
 </td>
    <td valign="top"><cfinput type="text" name="customerId" message="No Customer Found." required="yes" id="customerId" tabindex="2" readonly="yes" style="width:100%"></td>
<td valign="top"><cfselect name="AccountID" id="AccountID" required="yes" bind="cfc:#request.cfc#cfc.bind.getAllBankAccounts()" display="AccountID" value="AccountID" tabindex="1" bindonload="yes" style="width:100%"> </cfselect></td>
<td>
<cfinput type="datefield" mask="dd/mm/yyyy" value="#lsdateformat(now(),"mm/dd/yyyy")#" name="paymentDate" id="paymentDate" tabindex="3" title="Payment Date" required="yes" message="Enter valid Date" style="width:100%"/>
</td>

<td valign="top"><cfselect name="payType" id="payType" required="yes"  bind="cfc:#request.cfc#cfc.bind.getPaymentType()" display="PaymentType" value="PaymentType" bindonload="yes" style="width:100%" tabindex="5">
    </cfselect></td>
<td valign="top"> <cfinput name="Details" id="Details" type="text" tabindex="6"  style="width:100%"> 
</td>
...
<td align="center" valign="top">  <cfinput type="submit" name="addInvoice" id="addInvoice" value="Add" tabindex="8"></td>
...
<td align="right" valign="top"> <div align="left">#session.myInvoice[variables.counter].paymentDate# </div></td>
<td align="right" valign="top"> <div align="left">#session.myInvoice[variables.counter].ref#</div></td>
<td align="right" valign="top"> <div align="left">#session.myInvoice[variables.counter].payType#</div></td>
...
<tr>
  ...
  <td align="center"><a href="../Payment/payment.cfm?reset=1"><font color="##FF0000"><strong>Reset</strong></font></a>&nbsp;<a href="#cgi.SCRIPT_NAME#?sales=yes"><font color="##000000"><strong>Post</strong></font></a></td>
</tr>
</tbody>
</table>
</div>
