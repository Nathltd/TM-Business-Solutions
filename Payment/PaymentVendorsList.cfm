...
SELECT PaymentDate, PaymentID, vendorID, AccountID, Amount, type, creator
FROM vwVendorPayment
WHERE 	PaymentDate between <cfqueryparam value="#dateformat(session.startDate,"dd/mm/yyyy")#" cfsqltype="cf_sql_date">
		...
		<cfelse>
        AND vendorID = <cfqueryparam value="#trim(session.vendorID)#"cfsqltype="cf_sql_clob">
        </cfif>
...
<table width="577">
  ...
  <tr>
    <td width="32" valign="top"><div align="left"><font face="Segoe UI" size="-2">Supplier:</font></div></td>
    <td width="141" valign="top"><div align="left"><strong><font face="Segoe UI" size="-2">#session.vendorID#</font></strong></div></td>
...
<td width="107"><strong>Supplier</strong></td>
...
<td><div align="left">#vendorID#</div></td>
...
<tr align="center">
  ...
  <td width="20%" valign="top">
    <div align="left">
      <cfselect name="vendorID" message="Choose Product"  required="yes" id="vendorID" style="width:100%">
        <option value="All" selected>All</option>
        <cfloop query="suppliers">
          <option value="#vendorID#" <cfif Suppliers.vendorID is #form.vendorID#> selected </cfif>>#vendorID#</option>
          </cfloop>
        </cfselect>
      </div></td>
  <td width="20%" valign="top">
