...
SELECT CustomerID, OpeningBalance, Total, TotalPaid, Rebate, Balance
...
<cfelse>
  ...
  <div align="right">
  <cfoutput>Customers on Record =<strong> #CustomerBalance.recordCount#</strong></cfoutput>&nbsp;
  </div>
  ...
  <td width="10%" align="right"><strong>Opening Balance</strong></td>
  <td width="15%" align="right"><strong>Sales</strong></td>
  <td width="15%" align="right"><strong>Amount Paid</strong></td>
  <td width="15%" align="right"><div align="right"><strong>Rebate</strong></div></td>
  <!--<td width="33" hidden="yes">Calc</td>-->
...
<cfif IsDefined("rowColor")Is False or rowColor is "FFFFFF"><cfset rowColor="E8E8E8"><cfelse><cfset rowColor="FFFFFF"></cfif>
<tr bgcolor="#rowColor#" onMouseOver="this.bgColor='FFCCCC';" onMouseOut="this.bgColor='#rowColor#';">
  <td width="182" align="left"><font color="#Bcolor#"><a href="#cgi.SCRIPT_NAME#?id=#customerID#">#CustomerID#</a></font></td><td width="130"><div align="right"><font style="font-weight: normal">#numberformat(OpeningBalance,",000.00")#</font></div></td><td width="130"><div align="right"><font style="font-weight: normal">#numberformat(Total,",000.00")#</font></div></td><td width="130"><div align="right"><font style="font-weight: normal">#numberformat(TotalPaid,",000.00")#</font></div></td><td width="130"><div align="right"><font style="font-weight: normal">#numberformat(Rebate,",000.00")#</font></div></td><td width="125"><div align="right"><font color="#Bcolor#">#numberformat(Balance,",000.00")#</font></div></td>
  </tr>
</cfoutput>
      <cfquery name="CustomerBalanceTotal">
SELECT SUM(OpeningBalance) AS OpeningBal, SUM(Total) AS Totl, SUM(TotalPaid) AS Paid, SUM(Balance) AS Bal, SUM(Rebate) AS Reb
FROM vwCustomerPayBalance 
  </cfquery>
<cfoutput>
  <tr bgcolor="#rowColor#" onMouseOver="this.bgColor='FFCCCC';" onMouseOut="this.bgColor='#rowColor#';">
  <td width="182" align="left"><strong>Total</strong></td><td width="130"><div align="right"><strong>#numberformat(CustomerBalanceTotal.OpeningBal,",000.00")#</strong></div></td><td width="130"><div align="right"><strong>#numberformat(CustomerBalanceTotal.Totl,",000.00")#</strong></div></td><td width="130" align="right"><div align="right"><strong>#numberformat(CustomerBalanceTotal.Paid,",000.00")#</strong></div></td><td width="130" align="right"><div align="right"><strong>#numberformat(CustomerBalanceTotal.Reb,",000.00")#</strong></div></td><td width="125" align="right"><div align="right"><strong>#numberformat(CustomerBalanceTotal.Bal,",000.00")#</strong></div></td>
  </tr>
  </cfoutput>
</table>
</cfif>
...
<br />
  ...
  <td width="10%"><strong>Ref No.</strong></td><td width="62"><strong>Type</strong></td>
  <td width="20%"><strong>Account</strong></td>
  <td width="20%"><div align="right"><strong>Debit</strong></div></td>
  <td width="20%"><div align="right"><strong>Credit</strong></div></td>
  <!--<td width="33" hidden="yes">Calc</td>-->
  <td width="20%"><div align="right"><strong>Balance</strong></div></td>
  </tr>
<cfoutput query="CustomerDetails">
