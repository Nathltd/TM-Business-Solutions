...
<cfparam name="endRow" default="10">
<cfparam name="displayRow" default="10">
...
<cfquery name="product" datasource="tm001" >
select distinct productId from inventory
...
<cfoutput>
<cfset next = #startRow#+10>
<cfset previous = #startRow#-10>
<cfset lastRow = #next#+7>

<cfif #previous# GTE 1>
<a href="#cgi.SCRIPT_NAME#?startRow=#previous#&endRow=#evaluate(next-11)#"><b>Previous #displayRow# Records</b></a>
<cfelse>
Previous Records
</cfif>
<b>|</b>
<cfif #next# LTE #product.recordCount#>
<a href="#cgi.SCRIPT_NAME#?startRow=#next#&endRow=#evaluate(next+9)#"><b>Next
<cfif (#product.recordCount#-#next#) LT #displayRow#> #evaluate((product.recordCount-next)+1)# 
<cfelse> #displayRow#
</cfif> Records</b></a>
<cfelse>
Next Records
...
<table width="600">
<cfloop query="product" startrow="#startRow#" endrow="#endRow#">

<!---Calculation for Opening Balance--->
<cfquery name="TotalQty">
SELECT TypeID, SUM(Qty) AS Qty1, ProductID FROM vwProductTransactUnion
WHERE ddate >= #CreateODBCDate(request.StartYear)# AND ddate <= #CreateODBCDate(session.EndDate)# AND ProductID = '#product.ProductID#' AND BranchID = '#session.BranchID#'
