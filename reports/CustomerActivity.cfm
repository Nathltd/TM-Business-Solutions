...
<td>#Dateformat(dDate,"dd/mm/yyyy")#</td><td>#TypeID#</td><td><div align="right">#Qty#</div></td>
...
<table width="595" border="0" cellpadding="0" cellspacing="0">
<tr>
  <td width="105"><strong>Date</strong></td><td width="121"><strong>Transaction</strong></td><td width="73"><div align="right"><strong>Qty</strong></div></td><td width="101" hidden="yes" ><div align="right"><strong>Cal</strong></div></td><td width="84"><div align="right"><strong>Balance</strong></div></td>
</tr>
<tr bgcolor="#C0C0C0">
  <td>&nbsp;</td>
  <td>&nbsp;</td>
...
<cfif IsDefined("rowColor")Is False or rowColor is "FFFFFF"><cfset rowColor="E8E8E8"><cfelse><cfset rowColor="FFFFFF"></cfif>
<tr bgcolor="#rowColor#" onMouseOver="this.bgColor='FFCCCC';" onMouseOut="this.bgColor='#rowColor#';">
<td>#Dateformat(dDate,"dd/mm/yyyy")#</td><td>#TypeID#</td><td><div align="right">#Qty#</div></td><td hidden="yes"><div align="right">
#Qty2#
