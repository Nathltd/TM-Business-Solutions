...
<div id="Content">
<h4>Credit Note Reprint</h4>
<div id="RightColumn">

<cfquery name="CreditNote">
SELECT BranchID,CreditNoteID,ApplyAs,CreditNoteDate,CustomerID,StaffID
FROM CreditNote
WHERE CreditNoteID = <cfqueryparam value="#Trim(url.CFGRIDKEY)#" cfsqltype="cf_sql_clob">
</cfquery>

<cfquery name="CreditNoteDtls">
SELECT ID,CreditNoteID,ProductID,Qty,Description, UnitPrice, Amt
FROM vwCreditNoteDetails
WHERE CreditNoteID = <cfqueryparam value="#Trim(url.CFGRIDKEY)#" cfsqltype="cf_sql_clob">
</cfquery>
...
<font size="+3" face="Segoe UI" color="##666666"><strong>Credit Note</strong></font>
</td>
</tr>
<tr>
<td>
...
<td width="95"><div align="left"><font size="-1" face="Segoe UI">Date:</font>  <font size="-1" face="Segoe UI"><br>
  Invoice ##:</font></div></td>
<td width="107"><div align="left"><font size="-1" face="Segoe UI"><strong> #Dateformat(CreditNote.CreditNoteDate,"dd/mm/yyyy")#</strong></font></div>
<div align="left"><font size="-1" face="Segoe UI"><strong>  #CreditNote.CreditNoteID#</strong></font></div></td>
</tr>
<tr>
  <td></td>
  <td><div align="left"><font size="-1" face="Segoe UI">Issued at:</font></div></td>
  <td><div align="left"><font size="-1" face="Segoe UI"><strong>#CreditNote.BranchID#</strong></font></div></td>
</tr>
<tr>
<td>
<div align="left">To:
<br>
#CreditNote.CustomerID#</div>
</td>
<td colspan="2">
  <div align="right"></div>
...
<td>
<div align="left"><font size="-1" face="Segoe UI"><strong> #CreditNote.StaffID#</strong></font>
</div>
</td>
</tr>
</table>
