...
<body>
<cfparam name="url.cfgridkey" default="#salesId#">
...
Email: #request.CompanyEmail#</Span>
		...
		<table id="items">
		  ...
		  <tr>
		      <th>Quantity</th>
		      <th>Item</th>
		      <th>Unit-Cost<br />(&##8373)</th>
              <th>Discount<br />(&##8373)</th>
		      <th>Price<br />(&##8373)</th>
		  </tr>
		  <cfloop query="SalesDetails">
		  <tr class="item-row">
		      <td class="quantity" align="center">#LSNumberFormat(Qty,',999')#</td>
		  ...
		  <tr>
		      ...
		      <td class="total-value"><div id="total"><strong>&##8373 #LSNumberFormat(Amounts.TotalAmount,',9999999999.99')#</strong></div></td>
		  </tr>
		  <tr>
		      <td colspan="2" class="blank"> </td>
		      <td colspan="2" class="total-line"><strong>Amount Paid</strong></td>

		      <td class="total-value"><strong>&##8373 #LSNumberFormat(Amounts.AmountPaid,',9999999999.99')#</strong></td>
		  </tr>
		  <tr>
		      <td colspan="2" class="blank"> </td>
		      <td colspan="2" class="total-line balance"><strong>Balance Due</strong></td>
		      <td class="total-value balance"><div class="due"><strong>&##8373 #LSNumberFormat(Balance,',9999999999.99')#</strong></div></td>
		  </tr>
