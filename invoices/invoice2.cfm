    ...
    <cfparam name="url.type" default="">
		...
		<div id="identity">
            ...
            <div id="logo" align="center">
              ...
              <img src="../Invoices/images/#option.logo#" alt="logo" width="650" height="100" id="image" />
       	</div>
        <div align="center">
            <!---<Span id="address" hidden="yes">#ucase(option.company)#</Span><br />--->
            <span> #request.CompanyAddress#<br />
Phone: #request.CompanyPhone#, #request.CompanyPhone2#, #request.CompanyPhone3# <br />Email: #request.CompanyEmail#</Span>
            </div>
