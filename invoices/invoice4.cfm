...
<cfoutput>
<cfquery name="Sales">
SELECT BranchID,SalesID,AmountPaid,AccountID,SalesDate,CustomerID,StaffID,paymode
FROM Sales
	...
	<div id="page-wrap">
	  ...
	  <div id="identity">
            ...
            <div id="logo" align="center">
              <!---<img id="image" src="../image/LG-Electronics.jpg" alt="logo" width="90%" />--->
              <img src="../Invoices/images/#option.logo#" alt="logo" height="120" id="image" />
       	</div>
        </div> 
        <div id="addressline">      
              <div id="address1">
...
Phone: #request.CompanyPhone3#</Span>
    ...
    <cfparam name="url.type" default="">
        ...
        <div id="invoice">SALES ORDER</div>
        <cfelse>
		<div id="invoice">#url.InvoiceType# INVOICE</div>
        </cfif>
		...
		<div id="customer">
            ...
            <textarea rows="4" id="customer-title">Billed To: &##13;&##10;Name:       #customer# &##13;&##10;Address:  #company# &##13;&##10;Phone:     #address# 
            			</textarea>            
            ...
            <table id="meta">
                ...
                <tr>
                    <td class="meta-head">Pay Mode</td>
                    <td><div class="due">#Sales.paymode#</div></td>
                </tr>
                <tr>
		...
		<table width="50" id="items">
		  ...
		  <tr>
		      ...
		      <td class="total-value"><div id="total"><strong>&##x20a6 #LSNumberFormat(Amounts.AmountPaid,',9999999999.99')#</strong></div></td>
		  </tr>
		  <tr>
		      <td colspan="3" class="blank"> </td>
      ...
      <div id="signature">
	    <textarea>Customer's Signature:____________________                                                                               					Signed By: #Sales.StaffID#</textarea>
		</div>
