...
<html>
<head>
<title><cfoutput>Rebate Modification :: #request.title#</cfoutput></title>
...
<div id="Content">
<h4>Rebate Modification<cfif IsDefined("form.search") is True> for <cfoutput>#form.paymentDate#</cfoutput>
...
<cfquery>
INSERT into Rebate (AccountID,ExpenseID,Ref,RebateDate,Amount,CustomerID,Details,Creator) 
...
VALUES ('#form.PaymentUpdate.AccountId[counter]#','#form.PaymentUpdate.ExpenseID[counter]#', #form.PaymentUpdate.Ref[counter]#,<cfqueryparam value="#lsDateFormat(CreateODBCDate(session.paymentDate), "dd/mm/yyyy")#" cfsqltype="cf_sql_date">,'#Form.PaymentUpdate.Amount[counter]#','#Form.PaymentUpdate.CustomerID[counter]#','#Form.PaymentUpdate.Details[counter]#','#GetAuthUser()#',1)
</cfquery>
...
RebateDate = <cfqueryparam value="#lsDateFormat(CreateODBCDate(session.paymentDate), "dd/mm/yyyy")#" cfsqltype="cf_sql_date">,
...
<p>
<cfoutput> Rebate have been Updated successfully<a href="#cgi.SCRIPT_NAME#"> New Payment </a></cfoutput>
</p>
...
SELECT ID,AccountID,ExpenseID,Ref,RebateDate,Amount,CustomerID,Details,Creator
FROM Rebate
WHERE RebateDate = <cfqueryparam value="#dateformat(form.PaymentDate,"dd/mm/yyyy")#" cfsqltype="cf_sql_date">
...
<br />
There was no Rebate on <cfoutput><strong> #form.PaymentDate#</strong> </cfoutput><br /><br />
Click <a href="?">here for another Rebate Search</a>.
...
<thead>
<tr align="center">
<td colspan="6" align="center" valign="top"><cfgrid name="PaymentUpdate"  query="Payments"  insert="yes" insertbutton="Add"  delete="yes" deletebutton="Remove" gridlines="no" format="applet" fontsize="12"colheaderbold="Yes" colheaders="yes" font = "Tahoma" selectcolor="##949494" selectmode = "Edit" width="520" rowheaders="no">
...
<cfgridcolumn name = "ExpenseID" header = "Expense Type" width="100" headeralign="center" values="#ValueList(ExpenseType.AccountID)#" valuesdelimiter=",">
<cfgridcolumn name = "CustomerID" header = "Customer" width="100" headeralign="center" values="#ValueList(Customer.CustomerID)#" valuesdelimiter=",">
<cfgridcolumn name = "Details" header = "Details" width="220" headeralign="center">
