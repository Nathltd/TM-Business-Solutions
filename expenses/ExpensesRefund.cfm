...
<html>
<head>
<title><cfoutput>Refund from Vendors  :: #request.title#</cfoutput></title>
...
<cfoutput> Refunds have been posted successfully<a href="#cgi.SCRIPT_NAME#"> New Posting</a></cfoutput><br>
<br>
<cfset structdelete(session, 'AccountID')>
<cfset structdelete(session, 'VendorID')>
<cfset structdelete(session, 'expenseDate')>
...
<td>
<cfinput type="datefield" style="width:100%" mask="dd/mm/yyyy" placeholder="#dateformat(now(),"dd/mm/yyyy")#" name="expenseDate" id="expenseDate" tabindex="3" title="Refund Date" required="yes" message="Enter valid date"/>
