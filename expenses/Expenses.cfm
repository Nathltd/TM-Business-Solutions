...
<td valign="top"><cfselect name="AccountID" id="AccountID" required="yes"  message="Select A Product" bind="cfc:#request.cfc#cfc.bind.getAllBankAccounts()" display="AccountID" value="AccountID" tabindex="1" bindonload="yes"  style="width:100%"> </cfselect></td>
            <td valign="top"><cfselect name="SupplierID" id="SupplierID" style="width:100%" required="yes"  message="Select Supplier" bind="cfc:#request.cfc#cfc.bind.Vendor()"
