...
<html>
<head>
<title><cfoutput>Expense Account List  :: #request.title#</cfoutput></title>
...
<table width="90%">
  <tr>
    <td colspan="2" valign="top">Expense Account List</td>
    <td></td>
...
<table width="90%" cellpadding="0" cellspacing="5">
  <tr>
  <td colspan="6"><div align="right"><cfoutput>Accounts on Record =<strong> #accounts.recordCount#</strong></cfoutput>&nbsp;</div></td>

  </tr>
  <tr>
  <td width="50%"><strong>Account</strong></td>
  <td width="50%"><div align="left"><strong>Description</strong></div></td>
  </tr>
...
<tr bgcolor="#rowColor#" onMouseOver="this.bgColor='FFCCCC';" onMouseOut="this.bgColor='#rowColor#';">
  <td width="203" align="left">#accountId#</td><td width="295"><div align="left">#Description#</div></td>
  </tr>
</cfoutput>
</table>
</div>
...
<cfelse>
  ...
  <tr>
  <td colspan="1"></td>
  <td width="50%"><div align="right"><cfoutput>Accounts on Record =<strong> #accounts.recordCount#</strong></cfoutput>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="?print=1">Print</a></div></td>
  </tr>
  <tr>
...
<cfif IsDefined("rowColor")Is False or rowColor is "FFFFFF"><cfset rowColor="E8E8E8"><cfelse><cfset rowColor="FFFFFF"></cfif>
<tr bgcolor="#rowColor#" onMouseOver="this.bgColor='FFCCCC';" onMouseOut="this.bgColor='#rowColor#';">
  <td width="300" align="left">#accountId#</td><td width="350"><div align="left">#Description#</div></td>
  </tr>
</cfoutput>
</table>
</cfif>
