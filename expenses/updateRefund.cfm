...
<div id="Content">
<h4>Customer Refund Modification<cfif IsDefined("form.search") is True> for <cfoutput>#form.paymentDate#</cfoutput>
...
<cfquery>
INSERT into refund (AccountID,ExpenseID,Ref,RefundDate,Amount,CustomerID,Details,Creator) 
...
RefundDate = <cfqueryparam value="#lsDateFormat(CreateODBCDate(session.paymentDate), "dd/mm/yyyy")#" cfsqltype="cf_sql_date">,
...
SELECT ID,AccountID,ExpenseID,Ref,RefundDate,Amount,CustomerID,Details,Creator
FROM Refund
WHERE RefundDate = <cfqueryparam value="#dateformat(form.PaymentDate,"dd/mm/yyyy")#" cfsqltype="cf_sql_date">
