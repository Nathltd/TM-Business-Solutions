...
<html>
<head>
<title><cfoutput>Rebate  :: #request.title#</cfoutput></title>
...
<cfquery>
INSERT INTO rebate
(AccountID,customerID,rebateDate,ref,ExpenseID,details,amount,Creator,branchId)
...
<br />
<br />
<cfoutput> Rebate(s) have been posted successfully<a href="#cgi.SCRIPT_NAME#"> New Posting</a></cfoutput><br>
<br>
...
<td width="20%"><div align="left"><strong>Account</strong></div></td>
...
<td align="center" width="20%"> <div align="left"><strong>Ref.</strong></div></td>
<td align="center" width="20%"> <div align="left"><strong>Details</strong></div></td>
...
<tr>
<td valign="top"><cfselect name="accountId" id="accountId" required="yes" bind="cfc:#request.cfc#cfc.bind.getAllBankAccounts()" display="accountId" value="accountId" bindonload="yes" tabindex="2" style="width:100%"> </cfselect></td>
<td valign="top">
<cfselect name="CustomerID" id="CustomerID" required="yes" bind="cfc:#request.cfc#cfc.bind.getCustomers()" display="CustomerID" value="CustomerID" bindonload="yes" tabindex="2" style="width:100%"> </cfselect></td>
<td valign="top"><cfinput type="datefield" style="width:100%" mask="dd/mm/yyyy" placeholder="#dateformat(now(),"dd/mm/yyyy")#" name="expenseDate" id="expenseDate" tabindex="3" title="Expense Date" required="yes" message="Enter valid date"/></td>
<td valign="top"><cfinput type="text" name="ref" message="Enter Ref No." validate="float" required="yes" id="ref" style="text-align:right; width:100%" tabindex="4" autosuggest="no"><cfinput name="expenseId" id="expenseId" value="Rebate" type="hidden"><span id="msg">&nbsp;Ref. ## Already exist</span></td>
