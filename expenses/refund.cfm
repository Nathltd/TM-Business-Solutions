...
<html>
<head>
<title><cfoutput>Customer's Refund  :: #request.title#</cfoutput></title>
...
<cfquery>
INSERT INTO refund
(AccountID,customerID,refundDate,ref,ExpenseID,details,amount,Creator,branchId)
...
<br />
<br />
<cfoutput> Refund(s) have been posted successfully<a href="#cgi.SCRIPT_NAME#"> New Posting</a></cfoutput><br>
<br>
