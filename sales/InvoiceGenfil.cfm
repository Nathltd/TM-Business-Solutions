...
VALUES (<cfqueryparam cfsqltype="cf_sql_clob" maxlength="8" value="#session.SalesID#">,<cfqueryparam value="#dateformat(session.myDate,"dd/mm/yyyy")#" cfsqltype="cf_sql_timestamp">, '#session.BranchID#',  'General', '#session.StaffID#', <cfqueryparam value="#amountPaid#" cfsqltype="cf_sql_double">, <cfqueryparam value="#dateformat(session.todate,"dd/mm/yyyy")#" cfsqltype="cf_sql_timestamp">, '#GetAuthUser()#', '#session.BranchID#')
</cfquery>
<cfquery>
...
<div align="right"> <a href="#cgi.SCRIPT_NAME#"> New Invoice </a>  |  <a href="../invoices/invoice.cfm?cfgridkey=#url.cfgridkey#">Print</a>&nbsp;</div>
    ...
    <tr>
      ...
      <td width="162"><div align="left">
        <cfif isdefined('AddInvoice')>
          ...
          <cfinput type="hidden" name="AccountID" id="AccountID" size="10" required="yes" value="#AccountID#" readonly="yes" style="text-align:left; width:100%">
          <cfelse>
          <cfinput type="hidden" name="AccountID" id="AccountID" style="text-align:left; width:100%">
...
<button name="ok" id="ok">Ok</button>
    ...
    <td> <cfinput type="text" name="Price" validate="float" tabindex="10" required="yes" message="Enter item price" placeholder="0" onKeyUp="checkValue();" style="text-align:right; width:100%" autosuggest="no"> </td>
