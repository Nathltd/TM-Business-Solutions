...
<html>
<head>
<title><cfoutput>Data Back Up :: #request.title#</cfoutput></title>
...
<cfset uploadfolder = "#expandpath("/")##request.db#"><br />
...
<cfelse>
  ...
  <cffile action="copy" source="#uploadFile#" destination="#systemRoots[lastDrive]##request.Company##dateformat(now())#.bak"> 
