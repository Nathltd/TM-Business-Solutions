...
Enter the Data Code and browse to the Data File to restore from</p>
    <table width="60%" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF"> 
      <tr> 
        <td width="280" align="right"> Data Code: </td>
        <td width="300" align="right"><div align="left">
          <cfinput type="password" name="ItemCode" id="ItemCode" size="12" class="bold_10pt_black" autosuggest="off" required="yes" message="Enter Data Code" />
          </div></td>
      </tr> 
       <tr>
         <td align="right"><div align="right">Source:</div></td>
