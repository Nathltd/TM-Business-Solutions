...
INSERT INTO roomType (typeID, Description, norPrice, Creator)
VALUES ('#form.CategoryID#', '#form.Description#', '#form.Price#', '#GetAuthUser()#' ) 
</cfquery>
<div class="Results">
<cfoutput><font face="Verdana, Geneva, sans-serif" pointsize="12"><strong> #form.CategoryID# </strong></font>has been created successfully as a Room Category <a href="../Sales Reservation/newCategory.cfm"> click here</a> to continue </cfoutput>
</div>
<cfelse>
...
<td height="24"><div align="left">Description:</div></td>
  ...
  <td height="24"><div align="left">Price:</div></td>
  <td><cfinput type="text" name="price" id="price" required="yes" message="Enter A Product Name" autocomplete="off" autofocus></td>
</tr>
