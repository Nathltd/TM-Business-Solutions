...
INSERT into SalesDetails (SalesID,ProductID,Qty,UnitPrice,discount) 
    VALUES (#form.InvoiceNo#,'#Form.SalesUpdate.ProductID[counter]#',#Form.SalesUpdate.Qty[counter]#,#Form.SalesUpdate.UnitPrice[counter]#,#Form.SalesUpdate.Discount[counter]#)
</cfquery>
