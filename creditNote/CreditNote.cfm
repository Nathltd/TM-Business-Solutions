...
<html>
<head>
<title><cfoutput>Credit Note :: #request.title#</cfoutput></title>
...
(CreditNoteID,CreditNoteDate,BranchId,CustomerId,StaffID,LastUpdated,Creator,ApplyAs)
VALUES ('#session.SalesID#',
<cfqueryparam value="#lsDateFormat(CreateODBCDate(session.myDate), "dd/mm/yyyy")#" cfsqltype="cf_sql_date">, '#session.BranchID#',  '#session.customerID#', '#session.StaffID#',
<cfqueryparam value="#lsDateFormat(CreateODBCDate(session.todate), "dd/mm/yyyy")#" cfsqltype="cf_sql_date">, '#GetAuthUser()#', '#session.AccountID#')
</cfquery>
...
(ProductId, UnitPrice, Qty, CreditNoteID)
...
<cfoutput> Credit No. <strong>#session.SalesID#</strong> have been posted successfully<a href="../CreditNote/CreditNote.cfm"> New Credit Memo</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="../reports/CreditNotePrnt.cfm?CreditNoteID=#session.SalesID#">Print</a></cfoutput><br>
<br>
<table class="font2">
<cfoutput> 
<tr>
...
<td></td>
<td></td>
<td><div align="right">Credit No:</div></td>
...
<div align="center">
  <table width="90%" cellpadding="2">
    <tr>
      ...
      <td><div align="left">
        <cfif isdefined('form.AddInvoice')>
          ...
          <cfinput type="text" name="CustomerID" id="CustomerID" required="yes" style="width:100%" value="#CustomerID#" tooltip="Invoice Number" readonly="yes">
          <cfelse>
          <cfselect name="CustomerID" style="width:100%" id="CustomerID" tooltip="Customer's Name" message="Select a Customer" tabindex="1">
    ...
    <tr>
      <td><div align="left">Credit No:</div></td>
      <td><div align="left">
        <cfif isdefined('form.AddInvoice')>
          ...
          <cfelse>
          <cfinput name="SalesID" type="text" id="SalesID" required="yes" message="Enter an Invoice number" tooltip="Invoice Number" autocomplete="off" bind="cfc:#request.cfc#cfc.bind.invCredit()" bindonload="yes" style="text-align:right; width:100%">
          </cfif>
      </div></td>
      <td>&nbsp;</td>
      ...
      <td width="290"><div align="left">
        ...
        <cfif isdefined('form.AddInvoice')>
               ...
               <cfinput type="text" name="BranchID" id="BranchID" size="10" required="yes" style="width:100%" value="#BranchID#" readonly="yes">
       		   <cfelse>
            <cfselect name="BranchID" id="BranchID" required="yes" style="width:100%" message="Choose Location" bind="cfc:#request.cfc#cfc.bind.getBranches()" display="BranchID" value="BranchID" bindonload="yes" tabindex="3"> </cfselect>
...
<td> <cfinput type="text" name="Quantity" validate="float" tabindex="7" required="yes" message="Enter quantity sold" value="1" onKeyUp="checkValue();" style="text-align:right; width:100%"> </td>
...
<td align="center"><a href="../CreditNote/CreditNote.cfm?reset=1"><font color="##000000"><strong>Reset</strong></font></a>&nbsp;<a href="../CreditNote/CreditNote.cfm?sales=yes"><font color="##000000"><strong>Post</strong></font></a></td>
</tr>
</tbody>
