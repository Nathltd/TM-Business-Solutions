...
<link rel="stylesheet" href="../js/css/datepicker.css" type="text/css" />
	<script type="text/javascript" src="../js/js/jquery.js"></script>
	<script type="text/javascript" src="../js/js/datepicker.js"></script>
    <script type="text/javascript" src="../js/js/eye.js"></script>
    <script type="text/javascript" src="../js/js/utils.js"></script>
    <script type="text/javascript" src="../js/js/layout.js?ver=1.0.2"></script>
...
<cfif #Obalance.recordcount# gt 0>
<p>
...
'#session.myInvoice[variables.counter].itemQuantity#','#session.BranchID#', '#session.mydate#','#dateformat(now(),"dd/mm/yyyy")#','#GetAuthUser()#')
</cfquery>
</cfloop>
</cftransaction>
<br>
    ...
    <tr>
      ...
      <td><div align="left">
        <cfif isdefined('form.AddInvoice')>
          ...
          <cfinput type="text" name="OpNo" size="6" required="yes" class="bold_10pt_black" value="#invNo#" tooltip="O/P Number" readonly="yes" >
          <cfelse>
          <cfinput name="OpNo" type="text" id="OpNo" class="bold_10pt_black" size="6" required="yes" message="Enter an O/P number" tooltip="O/P Number" autosuggest="off" tabindex="1"/>
          </cfif>
      </div></td>
      <td width="40"><div align="left">Date:</div></td>
      <td width="121"><div align="left">
        <cfif isdefined('form.AddInvoice')>
          ...
          <cfelse>
          <cfinput type="datefield" class="bold_10pt_Date" mask="dd/mm/yyyy" placeholder="#dateformat(now(),"dd/mm/yyyy")#" name="mydate" id="mydate" tabindex="2" title="Invoice Date" required="yes" message="Enter Invoice Date"/>
    ...
    <tr>
      ...
      <td width="360"><div align="left">
        ...
        <cfif isdefined('form.AddInvoice')>
          ...
          <cfinput type="text" name="StaffID" size="10" required="yes" class="bold_10pt_black" value="#Staffd#" tooltip="Signatory" readonly="yes">   
          <cfelse>
          <cfselect name="StaffID" class="bold_10pt_black" id="StaffID" tooltip="Staff that signed the invoice" required="yes" message="Select Authorised" bind="cfc:#request.cfc#cfc.bind.getStaffFund({BranchID})" display="FirstName" value="FirstName" bindonload="yes" tabindex="4">
            </cfselect>
          </cfif>
        </div></td>
      ...
      <td><div align="left">
        ...
        <cfif isdefined('form.AddInvoice')>
          ...
          <cfelse>
          <cfselect name="BranchID" id="BranchID" required="yes" class="bold_10pt_black" message="Choose Location" bind="cfc:#request.cfc#cfc.bind.AllBranches()" display="BranchID" value="BranchID" bindonload="yes" tabindex="3"> </cfselect>
...
<td> <div align="right">
  <cfinput type="text" name="Quantity" validate="integer" tabindex="7"  required="yes" message="Enter quantity sold" value="1" size="6" style="text-align:right" autosuggest="off" onKeyUp="checkValue();"> 
</div></td>
...
<cfelseif isdefined("url.id") >
<cfset #ArrayDeleteAt(#session.tAmount#,#url.id#)#>
</cfif>
